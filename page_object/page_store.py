...
class PageStore():
    ...
    def rework_area_name(self,last_name,new_name):
        self.page.click_element((By.XPATH,f"//span[contains(text(), '{last_name}') and @class='active-cell-label']"))
    ...
    def table_add_search(self,name,area,adddress,linkman,phone):
        #self.page.click_element((By.XPATH,f"//span[contains(text(), '{area}') and @class='active-cell-label']"))
    ...
    def add_fail(self):
        sleep(2)
        return self.page.is_element_not_present((By.CLASS_NAME,'ivu-modal-body'))
    ...
    #修改门店失败验证方法
    def rework_fail(self):
        sleep(2)
        return self.page.is_element_not_present((By.CLASS_NAME, 'content-title'))
